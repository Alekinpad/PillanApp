...
/**
 * @(#)PilOutMsgWeb.java  Sabado 29 de Abril de 2017 - 14:28:45
 *
 *
...
/**
 * Implementa el WebService para accesar los métodos provistos por "PilOutMsg"
 * 
...
/**
 * Esta clase implementa el WebService "PilOutMsg".
 */
@WebService
public class PilOutMsgWeb
{
    @EJB
    private PilOutMsgRemote ejbRef;
     ...
     */
     ...
     public  KeyGetResult keyGet
         (@WebParam(name="codOutMsg") BigDecimal codOutMsg)
         throws PilOutMsgWebException
     {
         Date ejbDateTime = new Date();
         long timerStart = System.nanoTime();
         ...
         try
         {
             keyGetResult = getEJB().keyGet(codOutMsg);
         }
         catch (Exception ex)
         {
     ...
     */
         ...
         throws PilOutMsgWebException
     {
         ...
         try
         {
             keyGetLockResult = getEJB().keyGetLock(codOutMsg);
         }
         catch (Exception ex)
         {
     ...
     */
     ...
     public  UpdResult upd
         (@WebParam(name="codOutMsg") BigDecimal codOutMsg, @WebParam(name="codStt") long codStt, @WebParam(name="posX") String posX, @WebParam(name="posY") String posY, @WebParam(name="posZ") String posZ, @WebParam(name="indP") String indP, @WebParam(name="indI") String indI, @WebParam(name="indA") String indA, @WebParam(name="userName") String userName, @WebParam(name="domain") String domain, @WebParam(name="channel") String channel, @WebParam(name="gls") String gls, @WebParam(name="lnk") String lnk, @WebParam(name="transactTime") String transactTime, @WebParam(name="entryTime") String entryTime)
         throws PilOutMsgWebException
     {
         Date ejbDateTime = new Date();
         long timerStart = System.nanoTime();
         ...
         try
         {
             updResult = getEJB().upd(codOutMsg, codStt, posX, posY, posZ, indP, indI, indA, userName, domain, channel, gls, lnk, transactTime, entryTime);
         }
         catch (Exception ex)
         {
     ...
     */
         ...
         throws PilOutMsgWebException
     {
         ...
         try
         {
             delResult = getEJB().del(codOutMsg);
         }
         catch (Exception ex)
         {
     ...
     */
     ...
     public  KeyRangeResult keyRange
         (@WebParam(name="codOutMsgIni") BigDecimal codOutMsgIni, @WebParam(name="codOutMsgFin") BigDecimal codOutMsgFin, @WebParam(name="rowsPerPage") long rowsPerPage, @WebParam(name="isNextPage") long isNextPage)
         throws PilOutMsgWebException
     {
         Date ejbDateTime = new Date();
         long timerStart = System.nanoTime();
         ...
         try
         {
             keyRangeResult = getEJB().keyRange(codOutMsgIni, codOutMsgFin, rowsPerPage, isNextPage);
         }
         catch (Exception ex)
         {
     ...
     */
     ...
     public  KeyDelRangeResult keyDelRange
         (@WebParam(name="codOutMsgIni") BigDecimal codOutMsgIni, @WebParam(name="codOutMsgFin") BigDecimal codOutMsgFin)
         throws PilOutMsgWebException
     {
         Date ejbDateTime = new Date();
         long timerStart = System.nanoTime();
         ...
         try
         {
             keyDelRangeResult = getEJB().keyDelRange(codOutMsgIni, codOutMsgFin);
         }
         catch (Exception ex)
         {
     ...
     */
    private PilOutMsgRemote getEJB() throws java.lang.Exception
    {
        if (ejbRef == null)
        {
             InitialContext context = new InitialContext();
             ejbRef = (PilOutMsgRemote)context.lookup("ejb/cl/metagen/piloutmsg/PilOutMsg");//java:comp/env/ejbRef
        }
        return ejbRef;
    }
}
//{.Checksum("a9c14252f2f157d24580708f648488f1").}
