...
/**
 * @(#)KeyGetLockCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:45
 *
 *
 ...
 *             para el método "PilOutMsg.keyGetLock"
 * 
...
public class KeyGetLockCallerOracleBase //[001]
{
               ...
               PilOutMsgRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_OUT_MSG$KEY_GET_LOCK"); //[013]
        ...
        {
            throw new PilOutMsgException("Error detectado en el método KeyGetLockCallerOracleBase", Ex); //[046]
        }
        return keyGetLockResult; //[047]
    }
}
//{.Checksum("35b6c84986458f0550da197c56b2104c").}
