...
/**
 * @(#)UpdCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:45
 *
 *
...
public class UpdCallerOracleBase //[001]
{
               ...
               PilOutMsgRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_OUT_MSG$UPD"); //[013]
        ...
        {
            throw new PilOutMsgException("Error detectado en el método UpdCallerOracleBase", Ex); //[046]
        }
        return updResult; //[047]
    }
}
//{.Checksum("5e37c1ef85c6ebf179938599a869097d").}
