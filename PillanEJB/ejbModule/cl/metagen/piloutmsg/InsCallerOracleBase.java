...
/**
 * @(#)InsCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:45
 *
 *
...
public class InsCallerOracleBase //[001]
{
               ...
               PilOutMsgRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_OUT_MSG$INS"); //[013]
             ...
             */
            Oracle.setOutputParameter("COD_OUT_MSG", new BigDecimal(0)); //[024]
             ...
             */
            insResult.setCodOutMsg(OracleConversion.fromStringToBigDecimal(Oracle.getValue("COD_OUT_MSG"))); //[042]
        ...
        {
            throw new PilOutMsgException("Error detectado en el método InsCallerOracleBase", Ex); //[046]
        }
        return insResult; //[047]
    }
}
//{.Checksum("7928b2d6a580977df258c91bad2a8720").}
