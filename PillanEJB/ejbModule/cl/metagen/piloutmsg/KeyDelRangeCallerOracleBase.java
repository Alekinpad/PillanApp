...
/**
 * @(#)KeyDelRangeCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:45
 *
 *
 ...
 *             para el método "PilOutMsg.keyDelRange"
 * 
...
public class KeyDelRangeCallerOracleBase //[001]
{
               ...
               PilOutMsgRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_OUT_MSG$KEY_DEL_RANGE"); //[013]
        ...
        {
            throw new PilOutMsgException("Error detectado en el método KeyDelRangeCallerOracleBase", Ex); //[046]
        }
        return keyDelRangeResult; //[047]
    }
}
//{.Checksum("29414ce50489012bf0aa290ef60b89e7").}
