...
/**
 * @(#)KeyGetCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:45
 *
 *
 ...
 *             para el método "PilOutMsg.keyGet"
 * 
...
public class KeyGetCallerOracleBase //[001]
{
               ...
               PilOutMsgRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_OUT_MSG$KEY_GET"); //[013]
        ...
        {
            throw new PilOutMsgException("Error detectado en el método KeyGetCallerOracleBase", Ex); //[046]
        }
        return keyGetResult; //[047]
    }
}
//{.Checksum("7f6d69d87657430bcbfc632536b64005").}
