...
/**
 * @(#)SttDelRangeCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:45
 *
 *
 ...
 *             para el método "PilOutMsg.sttDelRange"
 * 
...
public class SttDelRangeCallerOracleBase //[001]
{
               ...
               PilOutMsgRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_OUT_MSG$STT_DEL_RANGE"); //[013]
        ...
        {
            throw new PilOutMsgException("Error detectado en el método SttDelRangeCallerOracleBase", Ex); //[046]
        }
        return sttDelRangeResult; //[047]
    }
}
//{.Checksum("ff2bfce1fd60031c4bcb23f856beb689").}
