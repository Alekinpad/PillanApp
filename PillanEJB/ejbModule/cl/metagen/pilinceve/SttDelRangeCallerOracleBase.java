...
/**
 * @(#)SttDelRangeCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:36
 *
 *
 ...
 *             para el método "PilIncEve.sttDelRange"
 * 
...
public class SttDelRangeCallerOracleBase //[001]
{
               ...
               PilIncEveRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_INC_EVE$STT_DEL_RANGE"); //[013]
        ...
        {
            throw new PilIncEveException("Error detectado en el método SttDelRangeCallerOracleBase", Ex); //[046]
        }
        return sttDelRangeResult; //[047]
    }
}
//{.Checksum("ad4e0f9042725a50ac60c4cb1f4fcfe5").}
