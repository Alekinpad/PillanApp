...
/**
 * @(#)StttmpRangeCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:36
 *
 *
 ...
 *             para el método "PilIncEve.stttmpRange"
 * 
...
public class StttmpRangeCallerOracleBase //[001]
{
               ...
               PilIncEveRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_INC_EVE$STTTMP_RANGE"); //[013]
             ...
             */
            Oracle.setOutputParameterList("PIL_INC_EVE_STTTMP_RANGE_CUR"); //[025]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "COD_INC_EVE", new BigDecimal(0)); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "COD_STT", 0); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "POS_X", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "POS_Y", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "POS_Z", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "IND_P", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "IND_I", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "IND_A", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "username", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "domain", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "channel", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "gls", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "lnk", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "transactTime", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_INC_EVE_STTTMP_RANGE_CUR", "entryTime", new String("")); //[026]
            Oracle.closeOutputParameterList("PIL_INC_EVE_STTTMP_RANGE_CUR"); //[027]
            ...
            uBound1 = Oracle.getNumRows("PIL_INC_EVE_STTTMP_RANGE_CUR"); //[032]
            for (rowIdx1 = 0; rowIdx1 < uBound1; rowIdx1++) //[033]
            {
                ...
                stttmpRangeOutDetalle1.setCodIncEve(OracleConversion.fromStringToBigDecimal(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "COD_INC_EVE", rowIdx1))); //[035]
                stttmpRangeOutDetalle1.setCodStt(OracleConversion.fromStringTolong(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "COD_STT", rowIdx1))); //[035]
                stttmpRangeOutDetalle1.setPosX(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "POS_X", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setPosY(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "POS_Y", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setPosZ(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "POS_Z", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setIndP(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "IND_P", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setIndI(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "IND_I", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setIndA(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "IND_A", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setUserName(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "username", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setDomain(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "domain", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setChannel(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "channel", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setGls(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "gls", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setLnk(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "lnk", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setTransactTime(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "transactTime", rowIdx1)); //[036]
                stttmpRangeOutDetalle1.setEntryTime(Oracle.getValue("PIL_INC_EVE_STTTMP_RANGE_CUR", "entryTime", rowIdx1)); //[036]
        ...
        {
            throw new PilIncEveException("Error detectado en el método StttmpRangeCallerOracleBase", Ex); //[046]
        }
        return stttmpRangeResult; //[047]
    }
}
//{.Checksum("18fc84053f0106c323d50da0320f26d0").}
