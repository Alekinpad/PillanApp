...
/**
 * @(#)InsCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:36
 *
 *
...
public class InsCallerOracleBase //[001]
{
               ...
               PilIncEveRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_INC_EVE$INS"); //[013]
             ...
             */
            Oracle.setOutputParameter("COD_INC_EVE", new BigDecimal(0)); //[024]
             ...
             */
            insResult.setCodIncEve(OracleConversion.fromStringToBigDecimal(Oracle.getValue("COD_INC_EVE"))); //[042]
        ...
        {
            throw new PilIncEveException("Error detectado en el método InsCallerOracleBase", Ex); //[046]
        }
        return insResult; //[047]
    }
}
//{.Checksum("bbee06f5ac8bd5d46a12ed9ff9241ca6").}
