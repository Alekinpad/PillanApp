...
/**
 * @(#)KeyGetCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:36
 *
 *
 ...
 *             para el método "PilIncEve.keyGet"
 * 
...
public class KeyGetCallerOracleBase //[001]
{
               ...
               PilIncEveRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_INC_EVE$KEY_GET"); //[013]
        ...
        {
            throw new PilIncEveException("Error detectado en el método KeyGetCallerOracleBase", Ex); //[046]
        }
        return keyGetResult; //[047]
    }
}
//{.Checksum("7aa3b04650fbcff1066c7cd0e9dc8b8f").}
