...
/**
 * @(#)KeyGetLockCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:36
 *
 *
 ...
 *             para el método "PilIncEve.keyGetLock"
 * 
...
public class KeyGetLockCallerOracleBase //[001]
{
               ...
               PilIncEveRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_INC_EVE$KEY_GET_LOCK"); //[013]
        ...
        {
            throw new PilIncEveException("Error detectado en el método KeyGetLockCallerOracleBase", Ex); //[046]
        }
        return keyGetLockResult; //[047]
    }
}
//{.Checksum("fac017172f1792f7536f171fa11c5cb8").}
