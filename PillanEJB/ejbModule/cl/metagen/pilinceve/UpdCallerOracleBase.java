...
/**
 * @(#)UpdCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:36
 *
 *
...
public class UpdCallerOracleBase //[001]
{
               ...
               PilIncEveRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_INC_EVE$UPD"); //[013]
        ...
        {
            throw new PilIncEveException("Error detectado en el método UpdCallerOracleBase", Ex); //[046]
        }
        return updResult; //[047]
    }
}
//{.Checksum("1e2b2dfaf4dc06489c8fc2dc086f7c04").}
