...
/**
 * @(#)StttmpDelRangeCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:36
 *
 *
 ...
 *             para el método "PilIncEve.stttmpDelRange"
 * 
...
public class StttmpDelRangeCallerOracleBase //[001]
{
               ...
               PilIncEveRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_INC_EVE$STTTMP_DEL_RANGE"); //[013]
        ...
        {
            throw new PilIncEveException("Error detectado en el método StttmpDelRangeCallerOracleBase", Ex); //[046]
        }
        return stttmpDelRangeResult; //[047]
    }
}
//{.Checksum("9625d555ee12269f28ff4624fb1a72b0").}
