...
/**
 * @(#)DelCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:25
 *
 *
...
public class DelCallerOracleBase //[001]
{
               ...
               PilAnaTskRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_ANA_TSK$DEL"); //[013]
        ...
        {
            throw new PilAnaTskException("Error detectado en el método DelCallerOracleBase", Ex); //[046]
        }
        return delResult; //[047]
    }
}
//{.Checksum("fde8932d4f04c1b9d94bdeb399c2b2c3").}
