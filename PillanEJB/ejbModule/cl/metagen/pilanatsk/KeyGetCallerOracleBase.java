...
/**
 * @(#)KeyGetCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:25
 *
 *
 ...
 *             para el método "PilAnaTsk.keyGet"
 * 
...
public class KeyGetCallerOracleBase //[001]
{
    
    /**
     * Construye un KeyGetCallerOracleBase.
     */
    public KeyGetCallerOracleBase() //[003]
    {
    }
    
    /**
     * Ejecuta el método  "KeyGet" implementación "Oracle".
     */
               ...
               PilAnaTskRollbackException //[005]
    {
        ...
        KeyGetResult keyGetResult = new KeyGetResult(); //[009]
        
        try //[101]
        {
            OracleConnector Oracle = new OracleConnector(); //[011]
            Oracle.setDataSource("pilDataSource"); //[012]
            Oracle.setServiceName("PIL_ANA_TSK$KEY_GET"); //[013]
            ...
            /**
             * Crea una estructura vacia de retorno de tipo KeyGetResult
             */
            keyGetResult = new KeyGetResult(); //[030]
            ...
            if(onErrorResultCode < 0) //[050c] PositiveErrorValues="false", NegativeErrorValues="true"
            {
                ...
                keyGetResult.setResultStatus(resultStatus); //[056]
                return keyGetResult; //[057]
            }
            ...
            else
            {
                ...
                keyGetResult.setResultStatus(resultStatus); //[2056]
            }
            
            /**
             * Extrae los valores del resultado Oracle, y puebla la estructura de retorno
             */
            keyGetResult.setCodStt(OracleConversion.fromStringTolong(Oracle.getValue("COD_STT"))); //[042]
            keyGetResult.setPosX(Oracle.getValue("POS_X")); //[043]
            keyGetResult.setPosY(Oracle.getValue("POS_Y")); //[043]
            keyGetResult.setPosZ(Oracle.getValue("POS_Z")); //[043]
            keyGetResult.setIndP(Oracle.getValue("IND_P")); //[043]
            keyGetResult.setIndI(Oracle.getValue("IND_I")); //[043]
            keyGetResult.setIndA(Oracle.getValue("IND_A")); //[043]
            keyGetResult.setUserName(Oracle.getValue("username")); //[043]
            keyGetResult.setDomain(Oracle.getValue("domain")); //[043]
            keyGetResult.setChannel(Oracle.getValue("channel")); //[043]
            keyGetResult.setGls(Oracle.getValue("gls")); //[043]
            keyGetResult.setLnk(Oracle.getValue("lnk")); //[043]
            ...
            keyGetResult.setTransactTime(stringTmp); //[043c]
            ...
            keyGetResult.setEntryTime(stringTmp); //[043c]
            keyGetResult.setResultCode(OracleConversion.fromStringTolong(Oracle.getValue("RESULT_CODE"))); //[042]
            keyGetResult.setResultMsg(Oracle.getValue("RESULT_MSG")); //[043]
        }
        catch (Exception Ex) //[044]
        {
            throw new PilAnaTskException("Error detectado en el método KeyGetCallerOracleBase", Ex); //[046]
        }
        return keyGetResult; //[047]
    }
}
//{.Checksum("44bd5e4810386ab26c1d79df2a1212d7").}
