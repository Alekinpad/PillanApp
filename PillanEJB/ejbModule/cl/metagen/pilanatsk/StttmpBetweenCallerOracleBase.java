...
/**
 * @(#)StttmpBetweenCallerOracleBase.java  Sabado 29 de Abril de 2017 - 14:28:25
 *
 *
 ...
 *             para el método "PilAnaTsk.stttmpBetween"
 * 
...
public class StttmpBetweenCallerOracleBase //[001]
{
               ...
               PilAnaTskRollbackException //[005]
    {
        ...
        try //[101]
        {
            ...
            Oracle.setServiceName("PIL_ANA_TSK$STTTMP_BETWEEN"); //[013]
             ...
             */
            Oracle.setOutputParameterList("PIL_ANA_TSK_STTTMP_BETWEEN_CUR"); //[025]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "COD_ANA_TSK", new BigDecimal(0)); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "COD_STT", 0); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "POS_X", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "POS_Y", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "POS_Z", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "IND_P", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "IND_I", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "IND_A", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "username", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "domain", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "channel", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "gls", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "lnk", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "transactTime", new String("")); //[026]
            Oracle.setOutputParameterField("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "entryTime", new String("")); //[026]
            Oracle.closeOutputParameterList("PIL_ANA_TSK_STTTMP_BETWEEN_CUR"); //[027]
            ...
            uBound1 = Oracle.getNumRows("PIL_ANA_TSK_STTTMP_BETWEEN_CUR"); //[032]
            for (rowIdx1 = 0; rowIdx1 < uBound1; rowIdx1++) //[033]
            {
                ...
                stttmpBetweenOutDetalle1.setCodAnaTsk(OracleConversion.fromStringToBigDecimal(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "COD_ANA_TSK", rowIdx1))); //[035]
                stttmpBetweenOutDetalle1.setCodStt(OracleConversion.fromStringTolong(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "COD_STT", rowIdx1))); //[035]
                stttmpBetweenOutDetalle1.setPosX(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "POS_X", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setPosY(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "POS_Y", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setPosZ(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "POS_Z", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setIndP(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "IND_P", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setIndI(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "IND_I", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setIndA(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "IND_A", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setUserName(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "username", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setDomain(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "domain", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setChannel(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "channel", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setGls(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "gls", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setLnk(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "lnk", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setTransactTime(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "transactTime", rowIdx1)); //[036]
                stttmpBetweenOutDetalle1.setEntryTime(Oracle.getValue("PIL_ANA_TSK_STTTMP_BETWEEN_CUR", "entryTime", rowIdx1)); //[036]
        ...
        {
            throw new PilAnaTskException("Error detectado en el método StttmpBetweenCallerOracleBase", Ex); //[046]
        }
        return stttmpBetweenResult; //[047]
    }
}
//{.Checksum("0bdf0f2a2e5bca1de913d3bb5d4dae3d").}
