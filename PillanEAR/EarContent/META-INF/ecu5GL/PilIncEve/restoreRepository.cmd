...
@rem --  Fecha de Creación: Sabado 29 de Abril de 2017 - 14:28:36                   
@rem --  Autor:             Ecu5GL.GenCode 3.20C18H (implementOracle V 3.20C18H)    
@rem --                                                                             
@rem --  Objetivo:                                                                  
@rem --             Restaurador del proyecto Ecu5GL PilIncEve.                      
...
@rem --                                                                             
@rem --
@echo procedimiento de recuperacion el proyecto PilIncEve
@echo  ------------------------------------------------------------------------
...
@echo 
@pause
@echo S:\services\PIL_INC_EVE.TXS
@     if not exist S:\services mkdir S:\services
@     copy   $services$PIL_INC_EVE.TXS.gz     S:\services\PIL_INC_EVE.TXS.gz /Y
@     pushd S:\services
@            T:\bin\gzip -9 -d -f -q PIL_INC_EVE.TXS.gz
@     popd
...
@     del /Q flex.tar
@     popd
@echo la recuperacion del proyecto PilIncEve ha concluido
@pause
