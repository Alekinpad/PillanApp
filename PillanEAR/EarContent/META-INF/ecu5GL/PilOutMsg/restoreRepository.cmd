...
@rem --  Fecha de Creación: Sabado 29 de Abril de 2017 - 14:28:45                   
@rem --  Autor:             Ecu5GL.GenCode 3.20C18H (implementOracle V 3.20C18H)    
@rem --                                                                             
@rem --  Objetivo:                                                                  
@rem --             Restaurador del proyecto Ecu5GL PilOutMsg.                      
...
@rem --                                                                             
@rem --
@echo procedimiento de recuperacion el proyecto PilOutMsg
@echo  ------------------------------------------------------------------------
...
@echo 
@pause
@echo S:\services\PIL_OUT_MSG.TXS
@     if not exist S:\services mkdir S:\services
@     copy   $services$PIL_OUT_MSG.TXS.gz     S:\services\PIL_OUT_MSG.TXS.gz /Y
@     pushd S:\services
@            T:\bin\gzip -9 -d -f -q PIL_OUT_MSG.TXS.gz
@     popd
...
@     del /Q flex.tar
@     popd
@echo la recuperacion del proyecto PilOutMsg ha concluido
@pause
