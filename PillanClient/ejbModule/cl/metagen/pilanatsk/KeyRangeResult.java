...
/**
 * @(#)KeyRangeResult.java  Sabado 29 de Abril de 2017 - 14:28:25
 *
 *
...
/**
 * Estructura de Datos: "PilAnaTsk.KeyRangeResult"
 * 
...
public class KeyRangeResult implements java.io.Serializable //[001]
{
    ...
    private BigDecimal myCodAnaTskIni = null; //[005]
    ...
    /**
     * Retorna el valor de codAnaTskIni
     */
           try
             {
               sb.append("[CodAnaTskIni,[" + this.myCodAnaTskIni + "]]"); //[014a]
             }
             catch(Exception e)
             {
               sb.append("[CodAnaTskIni,ERROR:[" + e.getMessage() + "]]"); //[014b]
             }
     ...
     * Retorna el valor de codAnaTskIni
     */
    public BigDecimal getCodAnaTskIni() //[013]
    {
        return this.myCodAnaTskIni; //[014]
    }
     ...
     * Asigna codAnaTskIni
     */
    public void setCodAnaTskIni(BigDecimal codAnaTskIni) //[023]
    {
        this.myCodAnaTskIni = codAnaTskIni; //[024]
    }
...
//{.Checksum("a77a478eb3224ccb5e8b03d8dae61154").}
