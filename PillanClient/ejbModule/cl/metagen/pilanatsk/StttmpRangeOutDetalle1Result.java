...
/**
 * @(#)StttmpRangeOutDetalle1Result.java  Sabado 29 de Abril de 2017 - 14:28:25
 *
 *
...
/**
 * Estructura de Datos: "PilAnaTsk.StttmpRangeOutDetalle1Result"
 * 
...
/**
 * Estructura de datos utilizada por el método "StttmpRange".
 */
public class StttmpRangeOutDetalle1Result implements java.io.Serializable //[001]
{
    private static final long serialVersionUID = 1L; //[002]
    private BigDecimal myCodAnaTsk = null; //[005]
    ...
    /**
     * Crea la representacion toMetaData() de  StttmpRangeOutDetalle1Result
     */
    public String toMetaData()
    {
        ...
        {
           sb = new StringBuffer();
           sb.append("NAME[StttmpRangeOutDetalle1Result], DATA[");
    
    /**
     * Retorna el valor de codAnaTsk
     */
           try
             {
               sb.append("[CodAnaTsk,[" + this.myCodAnaTsk + "]]"); //[014a]
             }
             catch(Exception e)
             {
               sb.append("[CodAnaTsk,ERROR:[" + e.getMessage() + "]]"); //[014b]
             }
    ...
    /**
     * Crea un StttmpRangeOutDetalle1Result
     */
    public StttmpRangeOutDetalle1Result() {} //[008]
    
    /**
     * Retorna el valor de codAnaTsk
     */
    public BigDecimal getCodAnaTsk() //[013]
    {
        return this.myCodAnaTsk; //[014]
    }
     ...
     * Asigna codAnaTsk
     */
    public void setCodAnaTsk(BigDecimal codAnaTsk) //[023]
    {
        this.myCodAnaTsk = codAnaTsk; //[024]
    }
...
//{.Checksum("6d2090cab9a564bff6407492b6748268").}
