...
/**
 * @(#)PilAnaTskException.java  Sabado 29 de Abril de 2017 - 14:28:25
 *
 *
...
public class PilAnaTskException extends Exception
{
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskException(String message)
    {
        super(message);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskException(Throwable cause)
    {
        super(cause);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskException(String message, Throwable cause)
    {
        super(message, cause);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskException(String message, Map<String, Object> map)
    {
        super(message);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskException(String procedureName, Exception ex)
    {
...
//{.Checksum("06de32f776e76f9d0c6533ca02fcedc8").}
