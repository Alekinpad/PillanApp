...
/**
 * @(#)PilAnaTskRollbackException.java  Sabado 29 de Abril de 2017 - 14:28:25
 *
 *
...
public class PilAnaTskRollbackException extends PilAnaTskException
{
     ...
     */
    public PilAnaTskRollbackException()
    {
        super();
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskRollbackException(String message)
    {
        super(message);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskRollbackException(Throwable cause)
    {
        super(cause);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskRollbackException(String message, Throwable cause)
    {
        super(message, cause);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskRollbackException(String message, Map<String, Object> map)
    {
        super(message);
    }
     ...
     * Construye un excepción nueva cuando se detecta una falla en una invocación de servicio.
     */
    public PilAnaTskRollbackException(String procedureName, Exception ex)
    {
...
//{.Checksum("916643ba61f2242171533985d38ba66f").}
